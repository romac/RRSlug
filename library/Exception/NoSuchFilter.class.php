...
/**
* Source file containing class RRSlug_Exception_NoSuchFilter.
* 
* @package    RRSlug
* @license    http://romac.github.com/files/BSD.txt New BSD License
* @author     Romain Ruetschi <romain.ruetschi@gmail.com>
* @version    0.1
* @see        RRSlug_Exception_NoSuchFilter
*/

/**
* Class RRSlug_Exception_NoSuchFilter.
* 
* Description for class RRSlug_Exception_NoSuchFilter.
*
* @package    RRSlug
* @license    http://romac.github.com/files/BSD.txt New BSD License
* @author     Romain Ruetschi <romain.ruetschi@gmail.com>
